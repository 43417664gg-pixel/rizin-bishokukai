...
window.DEMO_SEED = {
  ...
  fighters: [
    // ===== メインカード =====
    { id: "f_sabatello", name: "ダニー・サバテロ", nickname: "ザ・イタリアンギャングスター", belt: "RIZINバンタム級王者（第8代）",
    ...
    { id: "f_ota", name: "太田忍", nickname: "銀狼の処刑人", belt: "リオ五輪グレコローマン銀メダリスト",
    ...
    { id: "f_case", name: "ジョニー・ケース", nickname: "非情の貴公子",
    ...
    { id: "f_shoji", name: "昇侍", nickname: "秒殺侍", belt: "初代パンクラス・ライトヘビー級王者",
