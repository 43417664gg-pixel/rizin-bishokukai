...
window.DEMO_SEED = {
  ...
  fighters: [
    ...
    { id: "f_dautbek", name: "カルシャガ・ダウトベック", nickname: "シラット世界王者",
      ...
      career: "9歳でボクシングを始め2年で全国制覇→2015年MMA転向→2016年シラット世界大会を1日3試合全KOで優勝。2018年RIZIN初参戦で朝倉未来に判定負けするも、以降は6連勝（5連続KO）を含む快進撃。鈴木千裕・YA-MANも撃破",
    ...
    { id: "f_hagiwara", name: "萩原京平", nickname: "アンダーグラウンドエンペラー",
      ...
      career: "地下格闘技アマ20戦16勝で名を上げ2017年プロデビュー。2020年RIZIN初参戦から5ヶ月で4試合の売り出しで大ブレイク。平本蓮を2R TKOで沈めた大晦日は伝説。朝倉未来には判定負け。2026年は26秒TKO→左フックKOの2連続KO勝ちで復活中",
      memo: "ダウトベック戦は互いのKO率が保証する「どちらかが倒れる」カード",
    ...
    { id: "f_hinotori", name: "火の鳥",
      ...
      style: "初速で仕留める速攻型。直近は31秒TKOを含む3連勝と勢いだけなら本物",
      career: "本名・高木恭平、32歳。2024年10月MMAデビューの遅咲き。DEEPで3連勝中、2週間前に試合したばかりの体で篠塚辰樹（頚椎負傷欠場）の代役として大会5日前に電撃参戦",
      memo: "不死鳥の名の通り、中2週の強行軍で舞台をつかんだ",
    ...
    { id: "f_shoji", name: "昇侍", nickname: "初代キング・オブ・パンクラシスト",
      ...
      career: "アマ経験ゼロで2005年デビュー→2008年24歳でパンクラス初代王者。PANCRASE・DREAM・DEEPを渡り歩き朝倉海とも拳を交えた。一度の引退を経て2017年復帰、右前腕骨折の大手術からまた戻ってきた不屈のベテラン",
      memo: "「侍の誇りを持ち世界の頂点まで昇る」が名の由来",
    ...
    { id: "f_umeno", name: "梅野源治", nickname: "日本ムエタイ界の至宝",
      ...
      career: "ムエタイ最高峰ラジャダムナンのベルトを日本人で初めて巻いた立ち技のレジェンド。2023年MMA転向、大雅・芦澤竜誠に連勝→前戦はダイキに一本負け。MMA4戦目",
