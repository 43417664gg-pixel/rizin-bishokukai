...
window.DEMO_SEED = {
  ...
  fighters: [
    // ===== メインカード =====
    { id: "f_sabatello", name: "ダニー・サバテロ", nickname: "ジ・イタリアンギャングスター", belt: "RIZINバンタム級王者（第8代）",
    ...
    { id: "f_dautbek", name: "カルシャガ・ダウトベック", nickname: "キングオブカザフスタン",
      backbone: "ボクシング・シラット", team: "アメリカン・トップチーム", origin: "カザフスタン",
      rec_w: 18, rec_l: 3, rec_nc: 1, rec_ko: 14, rec_sub: 1, rec_dec: 3,
    ...
    { id: "f_ota", name: "太田忍", nickname: "銀の忍者レスラー", belt: "リオ五輪グレコローマン銀メダリスト",
      backbone: "レスリング（グレコローマン）", team: "THE BLACKBELT JAPAN", origin: "日本・青森",
    ...
    { id: "f_hiroya", name: "ヒロヤ", nickname: "不屈のヤングガン",
      backbone: "空手・キックボクシング", team: "JAPAN TOP TEAM", origin: "日本",
    ...
    { id: "f_arsen", name: "山本アーセン", nickname: "格闘一家の最強DNA",
      backbone: "アマチュアレスリング", team: "KRAZY BEE", origin: "日本・神奈川",
    ...
    { id: "f_case", name: "ジョニー・ケース", nickname: "ハリウッド非情の貴公子",
      backbone: "レスリング（元UFC）", origin: "アメリカ・アイオワ",
      rec_w: 28, rec_l: 10, rec_d: 1, rec_nc: 1, rec_ko: 20,
    ...
    { id: "f_riceyota", name: "林RICE陽太", belt: "GRACHAN二階級制覇王者",
    ...
    { id: "f_suzuki", name: "鈴木博昭", nickname: "怪物くん",
      backbone: "空手道・シュートボクシング", team: "BELLWOOD FIGHT TEAM", origin: "日本",
    ...
    { id: "f_shoji", name: "昇侍", nickname: "瞬殺侍", belt: "初代パンクラス・ライトヘビー級王者",
      backbone: "ムエタイ", team: "JAPAN TOP TEAM", origin: "日本",
    ...
    { id: "f_umeno", name: "梅野源治", nickname: "日本ムエタイ界の至宝",
      backbone: "ムエタイ", team: "PHOENIX／FIGHTER'S FLOW", origin: "日本・東京",
    ...
    { id: "f_oshima", name: "大島沙緒里", nickname: "極めのミクロクイーン",
      backbone: "柔道（弐段）", team: "リバーサルジム新宿Me,We", origin: "日本・島根",
