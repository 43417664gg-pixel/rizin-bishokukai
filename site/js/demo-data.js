...
window.DEMO_SEED = {
  ...
  fighters: [
    // LANDMARK 15 メインカード（プロフィールは確度の高いもののみ記載・admin画面から補完可）
    { id: "f_shiba",      name: "芝宏二郎", origin: "日本",
      rizin_url: "https://jp.rizinff.com/_tags/芝宏二郎" },
    { id: "f_harushin",   name: "遥心", origin: "日本",
      rizin_url: "https://jp.rizinff.com/_tags/遥心" },
    { id: "f_hinotori",   name: "火の鳥", origin: "日本",
      rizin_url: "https://jp.rizinff.com/_tags/火の鳥" },
    { id: "f_leejaehoon", name: "イ・ジェフン", origin: "韓国",
      rizin_url: "https://jp.rizinff.com/_tags/イ・ジェフン" },
    { id: "f_sasaki",     name: "佐々木信治", origin: "日本",
      memo: "国内MMA戦線を長く戦うベテラン",
      rizin_url: "https://jp.rizinff.com/_tags/佐々木信治" },
    { id: "f_riceyota",   name: "林RICE陽太", origin: "日本",
      rizin_url: "https://jp.rizinff.com/_tags/林RICE陽太" },
    { id: "f_suzuki",     name: "鈴木博昭", nickname: "スーパークレイジービースト",
      backbone: "シュートボクシング", origin: "日本",
      memo: "元シュートボクシング世界王者。打撃の破壊力が武器",
      rizin_url: "https://jp.rizinff.com/_tags/鈴木博昭" },
    { id: "f_miyagawa",   name: "宮川日向", origin: "日本",
      rizin_url: "https://jp.rizinff.com/_tags/宮川日向" },
    { id: "f_shoji",      name: "昇侍", backbone: "キックボクシング", origin: "日本",
      memo: "キック戦線を長く沸かせたベテランストライカー",
      rizin_url: "https://jp.rizinff.com/_tags/昇侍" },
    { id: "f_umeno",      name: "梅野源治", backbone: "ムエタイ", origin: "日本",
      memo: "元ラジャダムナン認定王者。日本ムエタイ最高峰の実績からMMA参戦",
      rizin_url: "https://jp.rizinff.com/_tags/梅野源治" },
    { id: "f_parksiu",    name: "パク・シウ", origin: "韓国",
      rizin_url: "https://jp.rizinff.com/_tags/パク・シウ" },
    { id: "f_suda",       name: "須田萌里", origin: "日本",
      rizin_url: "https://jp.rizinff.com/_tags/須田萌里" },
    { id: "f_oshima",     name: "大島沙緒里", origin: "日本",
      memo: "国内女子アトム級戦線の実力者",
      rizin_url: "https://jp.rizinff.com/_tags/大島沙緒里" },
    { id: "f_leeyeji",    name: "イ・イェジ", origin: "韓国",
      rizin_url: "https://jp.rizinff.com/_tags/イ・イェジ" },
    { id: "f_case",       name: "ジョニー・ケース", backbone: "MMA（元UFC）", origin: "アメリカ",
      memo: "元UFCファイター。RIZIN初期から参戦するオールラウンダー",
      rizin_url: "https://jp.rizinff.com/_tags/ジョニー・ケース" },
    { id: "f_tenya",      name: "天弥", origin: "日本",
      rizin_url: "https://jp.rizinff.com/_tags/天弥" },
    { id: "f_hiroya",     name: "ヒロヤ", backbone: "キックボクシング", origin: "日本",
      memo: "THE OUTSIDER出身。RIZINでキャリアを重ねる",
      rizin_url: "https://jp.rizinff.com/_tags/ヒロヤ" },
    { id: "f_arsen",      name: "山本アーセン", backbone: "レスリング", origin: "日本",
      memo: "山本KID徳郁の甥・母は山本美憂。レスリングエリートの血統",
      rizin_url: "https://jp.rizinff.com/_tags/山本アーセン" },
    { id: "f_ota",        name: "太田忍", backbone: "レスリング（グレコローマン）", origin: "日本",
      memo: "リオ五輪グレコローマン59kg級銀メダリスト",
      rizin_url: "https://jp.rizinff.com/_tags/太田忍" },
    { id: "f_tilenov",    name: "イリスベク・ティレノフ", origin: "キルギス",
      rizin_url: "https://jp.rizinff.com/_tags/イリスベク・ティレノフ" },
    { id: "f_dautbek",    name: "カルシャガ・ダウトベック", backbone: "散打", origin: "カザフスタン",
      memo: "強打で塩漬けなしの倒し合いスタイル",
      rizin_url: "https://jp.rizinff.com/_tags/カルシャガ・ダウトベック" },
    { id: "f_hagiwara",   name: "萩原京平", backbone: "ストライカー", origin: "日本",
      memo: "SMOKER GYM所属。大阪発の喧嘩スタイルで一撃KOを狙う",
      rizin_url: "https://jp.rizinff.com/_tags/萩原京平" },
    { id: "f_sabatello",  name: "ダニー・サバテロ", nickname: "RIZIN世界バンタム級王者（第8代）",
      backbone: "レスリング", origin: "アメリカ",
      memo: "American Top Team。ハイペースなレスリングとトラッシュトークの現王者",
      rizin_url: "https://jp.rizinff.com/_tags/ダニー・サバテロ" },
    { id: "f_kashimura",  name: "鹿志村仁之介", backbone: "レスリング", origin: "日本",
      memo: "レスリング全国レベルの実績からMMAへ。王座初挑戦",
      rizin_url: "https://jp.rizinff.com/_tags/鹿志村仁之介" },
    // LANDMARK 15 オープニング（若手中心・プロフィールはadminから補完）
